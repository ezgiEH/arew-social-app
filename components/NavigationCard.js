    ...
    return (
        <Card noPadding={true}>
            <div className='px-4 py-2 flex justify-between md:block'>
                <h2 className='text-gray-400 mb-3 hidden md:block'>Navigations</h2>
                ...
                <Link href={`/profile/${session.user?.id}/friends`} className={pathname === '/profile/friends' ? activeElementClasses : nonActiveElementClasses}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
